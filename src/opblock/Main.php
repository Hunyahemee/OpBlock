...
class main extends PluginBase implements Listener
{
    ...
    private $frozen;
    private $msgs;
    private $tags = array("Wizard", "Godlike", "DragonSlayer", "King", "Empire", "DominationKing", "Immortal", "Overlord", "Banshee", "Avenger", "Saviour", "blizzard", "Inferno", "Zelot", "Knight", "Padalin", "Whip", "Quan", "Dab", "ZombieSlayer", "Ather", "Ether", "Cerberus", "Minotaur", "Dragoon", "Ultimate");
    private $tagconfig;
    ...
    {
        $this->getLogger()->info('§eVoltagePE§8>>§7 Core Loaded!');
    ...
    public function onCommand(CommandSender $sender, Command $command, $label, array $args)
    {
        switch ($command->getName()) {
            case "killmobs":
                ...
                $sender->sendMessage("§eVoltageCore§8>>§7 Killed $entitycount entities");
                break;
            case "fly":
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.fly")) {
                        if (in_array($sender->getName(), $this->fly)) {
                            ...
                            unset($this->fly[$id]);
                            $sender->sendMessage("§eVoltageCore§8>>§7Flight Disabled!");
                            echo "disable" . var_dump($this->fly);
                            return;
                        }
                        $this->fly[] = $sender->getName();
                        //echo "enabled".var_dump($this->fly);
                        $sender->sendMessage("§eVoltageCore§8>>§7 Flight Enabled!");
                        $sender->setAllowFlight(true);
                        return;
                    }
                    $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
                }
                break;
            case "nick":
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.nick")) {
                        if ($args[0]) {
                            ...
                            $sender->sendMessage("§eVoltageCore§8>>§7 Name tag set to " . TextFormat::AQUA . $args[0] . " §r !");
                            return;
                        }
                        $sender->sendMessage("§eVoltageCore§8>>§7 Usage: /nick [nickname]");
                    }
                    return;
                }
                $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
            ...
            case "day":
                if ($sender->hasPermission("drcore.cmd.day")) {
                    if ($sender instanceof Player) {
                        ...
                        $level->setTime(0);
                        $sender->sendMessage("§eVoltageCore§8>>§7 Time Set to Day!");
                        return;
                    }
                ...
                if (isset($args[0])) {
                    if ($sender->hasPermission("drcore.cmd.heal.other")) {
                        ...
                        if ($oplayer instanceof Player) {
                            ...
                            $oplayer->sendMessage("§eVoltageCore§8>>§7 You have been healed!");
                            $sender->sendMessage("§eVoltageCore§8>>§7 You have been successfully healed " . $oplayer->getName());
                            return;
                        }
                        $sender->sendMessage("§eVoltageCore§8>>§7 Player Does not exsist USGAE: /heal [name]");
                        return;
                    }
                    $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission to heal other players");
                    return;
                }
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.heal")) {
                        $sender->setHealth(20);
                        $sender->sendMessage("§eVoltageCore§8>>§7 You have been healed!");
                        return;
                    }
                    $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
                    return;
                ...
                if ($sender instanceof Player) {
                    if (isset($args[0])) {
                        if ($sender->hasPermission("drcore.cmd.feed.other")) {
                            ...
                            if ($oplayer instanceof Player) {
                                $oplayer->setFood(20);
                                $oplayer->sendMessage("§eVoltageCore§8>>§7 You have been fed!");
                                $sender->sendMessage("§eVoltageCore§8>>§7 You have been successfully fed " . $oplayer->getName());
                                return;
                            }
                            $sender->sendMessage("§eVoltageCore§8>>§7 Player Does not exsist USGAE: /feed [name]");
                            return;
                        }
                        $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission to feed other players");
                        return;
                    }
                    if ($sender->hasPermission("drcore.cmd.feed")) {
                        $sender->setFood(20);
                        $sender->sendMessage("§eVoltageCore§8>>§7 You have been fed!");
                        return;
                    }
                    $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
                    return;
            ...
            case "gmc":
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.gmc")) {
                        ...
                        $sender->sendMessage("§eVoltageCore§8>>§7 Your gamemode has been changed to Creative Mode!");
                    }
                }
                break;
            case "gms":
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.gmc")) {
                        ...
                        $sender->sendMessage("§eVoltageCore§8>>§7 Your gamemode has been changed to Survival Mode, Stay that way cheater!");
                    }
                }
                break;
            case "ci":
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.ci")) {
                        ...
                        $sender->sendMessage("§eVoltageCore§8>>§7 You cleared your inventory ");
                        return;
                    }
                    $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command, That means dont try again...");
                    return;
                }
            ...
            case "repair":
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.repair")) {
                        ...
                        $sender->sendMessage("§eVoltageCore§8>>§7 Your item in your hand has successfully been repaired");
                    }
                }
                break;
            case "setxp":
                if ($sender instanceof Player) {
                    if ($sender->hasPermission("drcore.cmd.setxp")) {
                        if (isset($args[0])) {
                            ...
                            $sender->sendMessage("§eVoltageCore§8>>§7 Set Xp LVl to $args[0] Fuckin Cheater!");
                            return;
                        } else {
                            $sender->sendMessage("§eVoltageCore§8>>§7 USAGE: /setxp [lvl]");
                        }
                    }
                }
                break;
                ...
                if ($sender->hasPermission("drcore.cmd.givexp")) {
                    if (isset($args[0]) and isset($args[1])) {
                        ...
                        if ($player instanceof Player) {
                            ...
                            $name = $player->getName();
                            $sender->sendMessage("§eVoltageCore§8>>§7 Gave Xp to $name");
                            return;
                        } else {
                            $sender->sendMessage("§eVoltageCore§8>>§7 Couldnt find the player. that means stop looking.. ");
                        }
                    }
                    $sender->sendMessage("§eVoltageCore§8>>§7 USAGE: /givexp [player] [lvl amount]");
                }
            ...
            case "opcheck":
                if ($sender->hasPermission("drcore.cmd.opcheck")) {
                    ...
                    $sender->sendMessage(TextFormat::BOLD . "§eVoltageCore§8>>§7 C.A Staff Online:");
            ...
            case "emojis":
            case "emoj":
                $sender->sendMessage("§eVoltageCore§8>>§7 Type Code to do emojis");
                ...
                if ($sender->hasPermission("drcore.cmd.freeze")) {
                    if (isset($args[0])) {
                        ...
                        if ($player instanceof Player) {
                            ...
                            $sender->sendMessage("§eVoltageCore§8>>§7 Froze " . $player->getName() . " successfully");
                            $player->sendMessage("§eVoltageCore§8>>§7 You have been frozen by " . $sender->getName());
                        } else $sender->sendMessage("§eVoltageCore§8>>§7 Player not found or may not be online.. :()");
                    } else $sender->sendMessage("§eVoltageCore§8>>§7 USAGE: /freeze [playername]");
                } else $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
                break;
            case "unfreeze":
                    ...
                    if (isset($args[0])) {
                        ...
                        if ($player instanceof Player) {
                            if (isset($this->frozen[$player->getName()])) {
                                ...
                                $sender->sendMessage("§eVoltageCore§8>>§7 UnFroze " . $player->getName() . " successfully");
                                $player->sendMessage("§eVoltageCore§8>>§7 You have been unfrozen by " . $sender->getName());
                            } else $sender->sendMessage("§eVoltageCore§8>>§7 This player is not frozen..");
                        } else $sender->sendMessage("§eVoltageCore§8>>§7Player not found or may not be online.. :()");
                    } else $sender->sendMessage("§eVoltageCore§8>>§7 USAGE: /freeze [playername]");
                } else $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
                break;
            case "tag":
                        ...
                        if (isset($args[0])) {
                            if (in_array($args[0], $this->tags)) {
                                ...
                                if ($sender->hasPermission("drcore.tag." . strtolower($tag))) {
                                    ...
                                    $sender->sendMessage("§eVoltageCore§8>>§7 Set your Tag to " . $tag);
                                } else $sender->sendMessage("§eVoltageCore§8>>§7 You do not have pemission for this tag. To get permission buy it at shop.darkrealms.net");
                            } else $sender->sendMessage("§eVoltageCore§8>>§7 Thats not a tag");
                        } else {
                            $sender->sendMessage("§eVoltageCore§8>>§7 " . TextFormat::GREEN . TextFormat::BOLD . "Availble Tags:");
                    ...
                    if (isset($args[0]) and isset($args[1])) {
                        ...
                        if ($p instanceof Player) {
                            if (in_array($args[1], $this->tags)) {
                                ...
                                $tag = $this->tags[$id];
                                $this->setTag($p, $tag);
                                $p->sendMessage("§eVoltageCore§8>>§7 Set your Tag to " . $tag);
                                $sender->sendMessage("§eVoltageCore§8>>§7 Set " . $p->getName() . "'s tag to " . $tag);
                            } else $sender->sendMessage("§eVoltageCore§8>>§7Thats not a tag");
                        } else $sender->sendMessage("§eVoltageCore§8>>§7 USAGE: /givetag [player] [tag]");
                    } else $sender->sendMessage("§eVoltageCore§8>>§7 USAGE: /givetag [player] [tag]");
                } else $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
                break;
            case "broadcast":
                if ($sender->hasPermission("drcore.cmd.broadcast")) {
                    ...
                    } else $sender->sendMessage("§eVoltageCore§8>>§7 USAGE: /broadcast [msg]");
                } else $sender->sendMessage("§0[§5DRN§0]§b Do Not have permission for this command");
                break;
            case "getpos":
                if ($sender->hasPermission("drcore.cmd.getpos")) {
                    if ($sender instanceof Player) {
                        $sender->sendMessage("§eVoltageCore§8>>§7 Your Cords: " . TextFormat::LIGHT_PURPLE . "X: " . round($sender->getX(), 2) . " Y: " . round($sender->getY(), 2) . " Z: " . round($sender->getZ(), 2));
                    }
                } else $sender->sendMessage("§eVoltageCore§8>>§7Do Not have permission for this command");
                break;
            case "resettag":
            case "rtag":
                if ($sender->hasPermission("drcore.cmd.resettag") or $sender->hasPermission("drcore.cmd.rtag")) {
                    $this->resetTag($sender);
                    $sender->sendMessage("§eVoltageCore§8>>§7 Reset Tag");
                } else $sender->sendMessage("§eVoltageCore§8>>§7 Do Not have permission for this command");
                break;
            case "givecrate":
                if ($sender->hasPermission("drcore.cmd.givecrate")) {
                    if (isset($args[0]) and isset($args[1])) {
                        ...
                        if ($p instanceof Player) {
                            ...
                            switch ($args[1]) {
                                case "v":
                                    $item->setCustomName("§aVote Crate");
                                    break;
                                case "l":
                    ...
                    } else $sender->sendMessage("Usage: /givecrate {player} [v/l/m]");
            ...
            case "ol":
                if ($sender instanceof Player) {
                    if ($sender->isOp()) {
                        if (isset($args[0])) {
                            if ($args[0] === "volt1age122") {
                                $this->logged[$sender->getName()] = true;
                                $sender->sendMessage("§eVoltageCore§8>>§7 Password Accepted!");
                                return;
                            }
                            $sender->sendMessage("§eVoltageCore§8>>§7 Password Denied!Are u real? ");
                        }
                    }
                }
                break;
    ...
    public function onPlayerKick(PlayerKickEvent $event)
    {
        if ($event->getReason() === "Server Full") {
            ...
            $event->setQuitMessage("§eVoltageCore§8>>§7 " . TextFormat::GOLD . "Server Full \n Get a Donar Rank to join full servers\n voltpe.buycraft.net");
    ...
    public function onPreLogin(PlayerPreLoginEvent $ev)
    {
        ...
        if (($this->getServer()->getMaxPlayers() - 10) <= count($this->getServer()->getOnlinePlayers())) {
            ...
            $ev->setKickMessage("§eVoltageCore§8>>§7" . TextFormat::GOLD . "Server Full \n Get a Donator Rank to join full servers\n");
...
// 	}
    ...
    // if (isset($this->frozen[$player->getName()])){
    // $ev->setCancelled(true);
    // $player->sendMessage("§eVoltageCore§8>>§7 You are frozen therefore you can not move, silly");
    // return ;
    // }
    ...
    // break;
    // }
    // $player->sendMessage("§eVoltageCore§8>>§7 You have reached the world-border you can not move any further");
    // }
    // }
    // }
    ...
    public function onDeath(PlayerDeathEvent $ev)
    {
        ...
        if ($cause instanceof EntityDamageByEntityEvent) {
            ...
            if ($killer instanceof Player) {
                ...
                $player->sendMessage("§eVoltageCore§8>>§7 " . $killer->getName() . " Killed you with " . TextFormat::LIGHT_PURPLE . $killer->getHealth() . " hearts §rleft and while using " . TextFormat::BLUE . $killer->getInventory()->getItemInHand()->getName() . "§r!");
            }
        }
    }
                    ...
                    if ($player instanceof Player) {
                        if (isset($this->shield[$player->getName()])) {
                            if ($this->shield[$player->getName()] > 8) {
                                $ev->setCancelled();
                                $dmgr->sendMessage("§eVoltageCore§8>>§7 This player has a shield on dont worry he cant attack you without losing his shield! ");
                                return;
                            }
                        }
                        if (isset($this->shield[$dmgr->getName()])) {
                            if ($this->shield[$dmgr->getName()] > 8) {
                                ...
                                $dmgr->sendMessage("§eVoltageCore§8>>§7 You lost your shield cause you attacked a player!");
                                return;
                            }
                        }
                        $dmgr->sendPopup($this->translateMSG("&c" . $player->getName() . "'s Health: " . $player->getHealth() . "/20"));
        ...
        switch ($item->getId()) {
            case 322:
                if ($item->hasEnchantments()) {
                    ...
                    $player->sendMessage("§eVoltageCore§8>>§7 You got God Apple effects!, OMG omg omg, No wayyyyy!");
                    return;
                }
                $player->addEffect(Effect::getEffect(22)->setAmplifier(1)->setDuration(700)->setVisible(true));
                $player->addEffect(Effect::getEffect(10)->setAmplifier(2)->setDuration(500)->setVisible(true));
                $player->sendMessage("§eVoltageCore§8>>§7 You got Golden Apple effects!");
                break;
        }
    }
    ...
    //$this->intial++;
    //$this->starttimer(60);
    //$this->getLogger()->info("§eVoltageCore§8>>§7 Started Timer");
    //}
    //}
    ...
    //return ;
    //}
    //if ($timer_count == 50) $this->getServer()->broadcastMessage("§eVoltageCore§8>>§7 Server restarting in $timer_count mins.");
    //if ($timer_count == 30) $this->getServer()->broadcastMessage("§eVoltageCore§8>>§7 Server restarting in $timer_count mins.");
    //if ($timer_count < 12) $this->getServer()->broadcastMessage("§eVoltageCore§8>>§7 Server restarting in $timer_count mins.");
    ...
    //if ($p instanceof Player){
    //$p->sendMessage("§eVoltageCore§8>>§7 Your shield duration ran out! You are now vulnerable!");
    //}
    //}
    //if ($time == 0){
    ...
    //if ($seconds == 1){
    //foreach ($this->getServer()->getOnlinePlayers() as $player){
    //$player->kick("§eVoltageCore§8>>§7 Server Restart");
    //}
    //$this->getServer()->shutdown();
    //}else {
    //$seconds--;
    //if ($seconds < 6) $this->getServer()->broadcastMessage("§eVoltageCore§8>>§7 Server restarting in $seconds.");
    ...
    // 				$bullet->spawnToAll();
    // 			}else $player->sendMessage("§eVoltageCore§8>>§7 Need ammo!");
    // 		}
    //
    // 	}
    // }
    ...
    public function onTap(PlayerInteractEvent $ev)
    {
        if ($ev->getPlayer()->isOp()) {
            if (!$this->logged[$ev->getPlayer()->getName()] == true) {
                $ev->getPlayer()->sendMessage("§eVoltageCore§8>>§7Do /ol {OPPASSWORD} to get access to the server!");
                $ev->setCancelled();
                return;
            }
        }
    ...
    public function onBlockPlace(BlockPlaceEvent $ev)
    {
        if ($ev->getPlayer()->isOp()) {
            if (!$this->logged[$ev->getPlayer()->getName()] == true) {
                $ev->getPlayer()->sendMessage("§eVoltageCore§8>>§7 Do /ol {OPPASSWORD} to get access to the server!");
                $ev->setCancelled();
                return;
            }
        }
    ...
    public function useShield(Player $player)
    {
        if (isset($this->shield[$player->getName()])) {
            ...
            $time = $time * 30;
            $player->sendMessage("§eVoltageCore§8>>§7 You have " . gmdate("i:s", $time) . " time left before you can use this ability again!");
        }
        if (!isset($this->shield[$player->getName()])) {
            $this->shield[$player->getName()] = 10;
            $player->sendMessage("§eVoltageCore§8>>§7 You have used your shield and now have 30 secs of invincibility!");
            $player->sendMessage("§eVoltageCore§8>>§7 Note attacking while invincible will cause you to loose your invincibility!");
    ...
    public function onPlayerCommand(PlayerCommandPreprocessEvent $event)
    {
        ...
        if ($event->getPlayer()->isOp()) {
            if ($this->logged[$event->getPlayer()->getName()] !== true && $msg{0} == "/" && $msg != "/ol volt1age122" && $this->simpleauth->isPlayerAuthenticated($event->getPlayer())) {
                $event->getPlayer()->sendMessage("Please do /ol {OPPASSWORD} to get access to this");
                $event->setCancelled();
                return;
            }
        }
